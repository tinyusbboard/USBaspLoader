...
#ifdef TINYUSBBOARD_WITHCREDITS
#if defined (__AVR_ATmega8__) || defined (__AVR_ATmega8A__) || defined (__AVR_ATmega8HVA__)
const char credits[] BOOTLIBLINK = "USB v0.97.1, by Stephan Baerwolf";
#endif
#endif
...
const char credits[] BOOTLIBLINK = "USBaspLoader v0.97.1, by Stephan Baerwolf in Schwansee";
...
const char credits[] BOOTLIBLINK = "USBaspLoader v0.97.1, by Stephan Baerwolf (matrixstorm@gmx.de), Schwansee 2014";

const uint8_t freespace[] BOOTLIBLINK = {0xff, 0xff, 0xff, 0xff};
#elif defined (__AVR_ATmega328__)
const char credits[] BOOTLIBLINK = "USBaspLoader v0.97.1, by Stephan Baerwolf (matrixstorm@gmx.de), Schwansee 2014";

const uint8_t freespace[] BOOTLIBLINK = {0xff, 0xff, 0xff, 0xff};
#endif
const uint8_t finalfreespace[] BOOTLIBLINK = {
