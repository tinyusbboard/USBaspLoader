...
const char credits[70] BOOTLIBLINK = "20130507 USBaspLoader v0.96.2 by Stephan Baerwolf (matrixstorm@gmx.de)";
...
#if defined (__AVR_ATmega88__) || defined (__AVR_ATmega88P__)
const char credits[42] BOOTLIBLINK = "USBaspLoader v0.96.2, by Stephan Baerwolf";
#else
const char credits[62] BOOTLIBLINK = "USBaspLoader v0.96.2 by Stephan Baerwolf (matrixstorm@gmx.de)";
#endif
...
const char credits[62] BOOTLIBLINK = "USBaspLoader v0.96.2 by Stephan Baerwolf (matrixstorm@gmx.de)";
#else
const uint8_t freespace[1790+42] BOOTLIBLINK = {
...
const char credits[118] BOOTLIBLINK = "USBaspLoader v0.96.2 by Stephan Baerwolf (matrixstorm@gmx.de), Schwansee 2013\nhttp://matrixstorm.com/avr/tinyusbboard/";
#endif
//assume  SPMCR:=SPMCSR==0x37, SPMEN:=SELFPRGEN==0x0, RWWSRE=0x4, RWWSB=0x6
#if HAVE_SPMINTEREFACE_MAGICVALUE
const uint16_t bootloader__do_spm[23] BOOTLIBLINK = {
